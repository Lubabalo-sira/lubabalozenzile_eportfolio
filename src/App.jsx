      ...
      <BrowserRouter basename={"/"}>
        <div id="App" className={`relative w-full min-h-screen pb-20 ${Theme.bgColor}`}>
            ...
            <Switch>
                ...
                <Route path={"/eportfolio/ProfessionalDevelopment"} component={() => <ProfessionalDevelopment/>} />
                <Route path={"/eportfolio/Skills"} component={() => <Skills/>} />
                ...
                <Route path={"/eportfolio/CapstoneProject"} component={() => <CapstoneProject/>} />
